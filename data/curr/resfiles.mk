...
CURR_SYNTHETIC_ALIAS = az_AZ.txt az_Latn_AZ.txt bs_BA.txt bs_Latn_BA.txt\
 ...
 uz_AF.txt uz_UZ.txt vai_LR.txt vai_Vaii_LR.txt zh_CN.txt\
 zh_HK.txt zh_Hans_CN.txt zh_MO.txt zh_SG.txt zh_TW.txt
...
CURR_SOURCE = af.txt af_NA.txt agq.txt ak.txt\
 ...
 ms_Latn_SG.txt mt.txt mua.txt my.txt naq.txt\
