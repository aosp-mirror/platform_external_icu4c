...
#define MAX_NUMBER_OF_KEYWORDS 9
    const char *PREFERRED[PREFERRED_SIZE][MAX_NUMBER_OF_KEYWORDS+1] = {
            ...
            { "zh",             "pinyin", "stroke", "zhuyin", "eor", "search", "standard", NULL, NULL, NULL },  // android-changed
            { "zh_Hans",        "pinyin", "stroke", "zhuyin", "eor", "search", "standard", NULL, NULL, NULL },  // android-changed
            { "zh_CN",          "pinyin", "stroke", "zhuyin", "eor", "search", "standard", NULL, NULL, NULL },  // android-changed
            { "zh_Hant",        "stroke", "pinyin", "zhuyin", "eor", "search", "standard", NULL, NULL, NULL },  // android-changed
            { "zh_TW",          "stroke", "pinyin", "zhuyin", "eor", "search", "standard", NULL, NULL, NULL },  // android-changed
            { "zh__PINYIN",     "pinyin", "stroke", "zhuyin", "eor", "search", "standard", NULL, NULL, NULL },  // android-changed
#endif
    ...
    const int32_t expectedLength[PREFERRED_SIZE] = { 3, 3, 3, 4, 4, 6, 6, 6, 6, 6, 6, 4, 4, 3, 4, 3 };  // android-changed
#endif
