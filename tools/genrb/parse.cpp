...
keepCollationType(const char *type) {
    // BEGIN android-added
    if (uprv_strcmp(type, "big5han") == 0 && !gIncludeBig5HanColl) { return FALSE; }
    if (uprv_strcmp(type, "gb2312han") == 0 && !gIncludeGb2312HanColl) { return FALSE; }
    if (uprv_strcmp(type, "zhuyin") == 0 && !gIncludeZhuyinHanColl) { return FALSE; }
    // END android-added
