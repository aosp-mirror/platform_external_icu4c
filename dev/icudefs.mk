...
VERSION = 51.1.0.1
UNICODE_VERSION = 6.2
SO_TARGET_VERSION = 51.1.0.1
SO_TARGET_VERSION_MAJOR = 51
...
ICUDATA_BASENAME_VERSION = $(ICUPREFIX)dt51
# the entry point is almost like the basename, but has the lib suffix.  
ICUDATA_ENTRY_POINT = $(ICUPREFIX)dt51 
ICUDATA_CHAR = l
...
CFLAGS =  -O3 -Wall -std=c99 -pedantic -Wshadow -Wpointer-arith -Wmissing-prototypes -Wwrite-strings $(THREADSCFLAGS)
